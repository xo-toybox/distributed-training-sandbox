"""
Core training utilities for distributed setup.

- Model and tokenizer loading (SmolLM2-360M-Instruct)
- Dataset preparation (GLUE MRPC)
- Distributed process group helpers (rank, world size, process group)
- Seed management for reproducibility
- Tensor gathering and recursive tensor operations
"""
